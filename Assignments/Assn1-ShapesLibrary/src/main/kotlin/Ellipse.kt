...
class Ellipse(private var center: Point, private var radiusX: Double, private var radiusY: Double) {
    init {
    ...
    fun move(deltaX: Double, deltaY: Double) center.move(deltaX, deltaY)
}
